...
app.post('/inference', Auth, async (req, res) => {
  ...
  app.post('/transaction', Auth, async (req, res) => {
    try {
        const r = req.body
        let email,code, account, agent_id,amount, optional1, optional2, optional3 = r;

        const payurl = 'https://zuelpay.com/api/utility/billpay/transaction ';

        const data = await request.post(payurl,  {json: result });
        return res.json({ data: data });
  ...
  app.post('/fetchbill', Auth, async (req, res) => {
    try {
        const r = req.body
        let code, account,optional1,optional2,optional3 = r;
...
//https://zuelpay.com/api/utility/billpay/transaction 
